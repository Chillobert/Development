...
public final String masterBotImplsLocation = "de.hsa.games.fatsquirrel.botimpls";
...
private final String highscoreFile = "Highscore.tbl";
...
public BoardConfig_old(){
	...
	public int getAmountWalls(){
        ...
        /** Gets the path of the Highscore File 
        
         * @return the Path of HighscoreFile
         */
