...
public class BoardTest {
    ...
    //Überprüfe ob die Methode FillBoard auch mit der Anzahl an Entitys befüllt, wie laut BoardConfig vorgegeben wird-
	@Test
	...
	//Überprüfe ob die Methode getSize() die richtige Größe, die von der BoardConfig vorgeschrieben wird übergibt.
	@Test
	public void testGetSize(){
		assertNotNull(board.getSize()); //Prüfe ob Board Objekt initalisiert wird
		assertEquals(boardConfig.getSize(),  board.getSize()); //Prüfe Größe
	}
	
	//Überprüft ob die Methode getEntitySet() die entitySet soll die Anzahl an Entitys enthalten die vond er BoardConfig vorgegeben werden.
	@Test
